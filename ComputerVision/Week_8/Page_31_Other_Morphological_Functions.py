...
cv2.imshow("Filled Image", ImageFill(I))
cv2.waitKey(0)
cv2.destroyAllWindows()'''

#connectedComponentswithStats yields every seperated component with information on each of them, such as size
def ThresholdComponentWithSize(I,minSize,maxSize):
...
'''I = cv2.imread("text.png", cv2.IMREAD_GRAYSCALE)  #Example program
cv2.imshow("Filtered Image", ThresholdComponentWithSize(I,30,40))
cv2.waitKey(0)
cv2.destroyAllWindows()'''
